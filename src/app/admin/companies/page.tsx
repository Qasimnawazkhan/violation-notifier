...
export default function AdminCompaniesPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <form onSubmit={onCreate} className="grid gap-3 sm:grid-cols-4 bg-white border rounded p-4">
        <div>
        ...
        <div>
          ...
          <input
            ...
            placeholder="acme-transport"
          />
          <small className="text-xs text-gray-600">Optional: leave blank to auto-generate from name</small>
        </div>
        <div>
        ...
        {success && <div className="sm:col-span-4 text-sm text-green-600">Company created successfully.</div>}
      </form>
